...
public class Jugador {
    ...
    public Jugador(int id, String nickname, Set<Personaje> personajes, Map<Personaje, Integer> partidasGanadas) {
        this.id = id;
        this.nickname = nickname;
        this.personajesFavoritos = personajes;
    ...
    public String toString() {
        return "Jugador{" +
                "id=" + id +
                ", nickname='" + nickname + '\'' +
                ", personajes=" + personajesFavoritos +
